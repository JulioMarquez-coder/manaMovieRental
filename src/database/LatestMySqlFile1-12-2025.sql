...
INSERT INTO `movies` VALUES (1,'Incep','Christopher Nolan','Christopher Nolan','2010-07-13',148,'PG-13','Sci-Fi, Action','Leonardo DiCaprio, Joseph Gordon-Levitt, Ellen Page, Tom Hardy','https://m.media-amazon.com/images/I/71SBgi0X2KL._AC_UF894,1000_QL80_.jpg','A skilled thief enters people\'s dreams to steal secrets, but a final mission forces him to plant an idea instead of taking one.','2025-12-01 16:57:55',0,1);
...
CREATE TABLE `rentals` (
  ...
  `format` enum('DVD','BLURAY') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'DVD',
...
INSERT INTO `users` VALUES (14,'Isaiah','Xavier','Vega','9392908388','169 Calle Progreso','Aguadilla','00603','2003-10-22','IsaVega0802','roccO0802!','USER','2025-12-01 13:38:43'),(15,'Roberto',NULL,'Soto',NULL,NULL,'Aguadilla',NULL,'2002-10-21','RobSoto0802','roccO0802!','USER','2025-12-02 02:19:17');
...
-- Dump completed on 2025-12-02  0:02:00
